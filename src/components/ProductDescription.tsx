    ...
    <Container>
        {/* <DescriptionContainer > */}
            ...
            <DescriptionContainer>
                ...
                <FoodImg src={details?.result.detailImg} alt={`${details?.result.name}의 상세이미지`}/>
            </DescriptionContainer>
            <Title><u>Allergy Information</u></Title>
            <AllergyInfo>{(details?.result.allergy)? details.result.allergy : "No Allergy Found"}</AllergyInfo>
            <SpeakerContainer>
                <Title><u>Nutrition Facts</u></Title>
                <Speaker src={speaker} alt="speaker"/>
            </SpeakerContainer>
            <NutritionImg src={details?.result.nutritionImg} alt={`${details?.result.name}의 영양성분표`}/> 
            </>
