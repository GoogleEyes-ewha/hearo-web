...
const ProductReview = React.memo(({ itemId, data: reviews }: ProductReviewProps) => {
    ...
    const handleNextClick = () => {
        if (reviewList) {
            setCurrentIndex((prevIndex) => Math.min(prevIndex + 2, reviewList.result.reviewList.length - 2)); // 다음 2개 리뷰로 이동
        }
    };
    ...
    return(
        <Container>
            ...
            <svg width='105%' style = {{marginLeft: '-2.5%'}}xmlns="http://www.w3.org/2000/svg" height="12" viewBox="0 0 1062 12" fill="none">
                <path d="M0.666667 6C0.666667 8.94552 3.05448 11.3333 6 11.3333C8.94552 11.3333 11.3333 8.94552 11.3333 6C11.3333 3.05448 8.94552 0.666667 6 0.666667C3.05448 0.666667 0.666667 3.05448 0.666667 6ZM1050.67 6C1050.67 8.94552 1053.05 11.3333 1056 11.3333C1058.95 11.3333 1061.33 8.94552 1061.33 6C1061.33 3.05448 1058.95 0.666667 1056 0.666667C1053.05 0.666667 1050.67 3.05448 1050.67 6ZM6 7H1056V5H6V7Z" fill="#0A1128"/>
            </svg>
            <ReviewTitle style= {{marginTop: '50px'}}>Customer reviews</ReviewTitle>
            <ReviewTextBox>
                <svg onClick={handlePreviousClick} xmlns="http://www.w3.org/2000/svg" width="33" height="57" viewBox="0 0 33 57" fill="none">
                    <path d="M31.1173 1.1017C30.769 0.752479 30.3552 0.475407 29.8996 0.286359C29.444 0.0973107 28.9556 0 28.4623 0C27.9691 0 27.4807 0.0973107 27.0251 0.286359C26.5695 0.475407 26.1557 0.752479 25.8073 1.1017L0.877333 26.0317C0.599222 26.3092 0.378579 26.6389 0.228035 27.0018C0.0774906 27.3648 0 27.7538 0 28.1467C0 28.5396 0.0774906 28.9287 0.228035 29.2916C0.378579 29.6545 0.599222 29.9842 0.877333 30.2617L25.8073 55.1917C27.2773 56.6617 29.6473 56.6617 31.1173 55.1917C32.5873 53.7217 32.5873 51.3517 31.1173 49.8817L9.39733 28.1317L31.1473 6.3817C32.5873 4.9417 32.5873 2.5417 31.1173 1.1017Z" fill="#E8E8E8"/>
                </svg>
                ...
                <svg onClick={handleNextClick} xmlns="http://www.w3.org/2000/svg" width="33" height="57" viewBox="0 0 33 57" fill="none">
                    <path d="M1.1063 55.1922C1.45464 55.5415 1.86846 55.8185 2.32405 56.0076C2.77963 56.1966 3.26805 56.2939 3.7613 56.2939C4.25456 56.2939 4.74296 56.1966 5.19855 56.0076C5.65414 55.8185 6.06796 55.5415 6.4163 55.1922L31.3463 30.2622C31.6244 29.9847 31.8451 29.655 31.9956 29.2921C32.1461 28.9292 32.2236 28.5401 32.2236 28.1472C32.2236 27.7543 32.1461 27.3653 31.9956 27.0024C31.8451 26.6394 31.6244 26.3098 31.3463 26.0322L6.4163 1.10224C4.9463 -0.367764 2.5763 -0.367764 1.1063 1.10224C-0.363701 2.57224 -0.363701 4.94224 1.1063 6.41224L22.8263 28.1622L1.0763 49.9122C-0.363697 51.3522 -0.363701 53.7522 1.1063 55.1922Z" fill="#E8E8E8"/>
                </svg>
            </ReviewTextBox>
        </Container>
    );
